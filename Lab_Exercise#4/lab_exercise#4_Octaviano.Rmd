---
title: "Lab_Exercise#4_Octaviano"
...
base_url <- 'https://arxiv.org/search/?query=programming+language&searchtype=all&abstracts=show&order=-announced_date_first&size'
...
# dbWriteTable(connection, 'Lab_Exercise#4', articles, append = TRUE)
...
review_data <- dbGetQuery(connection, "SELECT * FROM 2c_octaviano.labexercise4")
glimpse(review_data)
